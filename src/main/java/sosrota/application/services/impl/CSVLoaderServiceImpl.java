...
public class CSVLoaderServiceImpl implements CSVLoaderService {
    ...
    @Override
    @Transactional
    public void carregarBairros(String caminhoArquivo) {
    ...
    @Override
    @Transactional
    public void carregarConexoes(String caminhoArquivo) {
        try (CSVReader reader = new CSVReader(new FileReader(caminhoArquivo))) {
            List<String[]> linhas = reader.readAll();
    ...
    @Override
    @Transactional
    public void carregarTodos(String caminhoBairros, String caminhoConexoes) {
        // Primeiro carrega os bairros
        carregarBairros(caminhoBairros);
        // Depois carrega as conexões (que dependem dos bairros)
        carregarConexoes(caminhoConexoes);
    }
}
